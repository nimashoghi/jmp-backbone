...
ckpt_path = CE.CachedPath(
    uri="hf://nimashoghi/mptrj-alex-omat24-jmp-s-mptrj-salex-finetune-tcky09h0/checkpoints/last/epoch2-step43049.ckpt"
)
...
results_dir = Path.cwd() / f"results/{Path(config.ckpt_path.uri).stem}"
