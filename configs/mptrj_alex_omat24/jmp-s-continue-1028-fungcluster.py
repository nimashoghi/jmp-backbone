...
continue_ckpt_path = CE.CachedPath(
    uri="/net/csefiles/coc-fung-cluster/nima/shared/experiment-data/nshtrainer/3mnzsq37/checkpoint/last/epoch0-step21541.ckpt"
)
env = {
...
def run(
    ...
    trainer.fit(module, datamodule, ckpt_path=continue_ckpt_path.resolve())
