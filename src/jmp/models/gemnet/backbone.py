...
from .graph import graphs_from_batch
...
from .scaling import load_scales_compat
from .utils import (
    get_angle,
    get_edge_id,
    get_inner_idx,
...
class GemNetOCBackbone(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # )
        self.embedding = nn.Embedding(num_elements, emb_size_atom)
    ...
    def forward(self, data: BaseData):
        ...
        h = self.embedding(atomic_numbers - 1)
